...
int Initialise(tFleshConfig *config) {
  ...
  // Check presync mode
  if (!CCTK_EQUALS(presync_mode, "mixed-error") && !CCTK_EQUALS(presync_mode, "presync-only"))
    CCTK_ERROR(
        "CarpetX currently requires Cactus::presync_mode = \"mixed-error\" or \"presyc-only\"");
