...
extern "C" void WaveToyXHybrid_Initial(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_WaveToyXHybrid_Initial;
...
#if 0
extern "C" void WaveToyXHybrid_EstimateError(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_WaveToyXHybrid_EstimateError;
  DECLARE_CCTK_PARAMETERS;
...
extern "C" void WaveToyXHybrid_RHS(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_WaveToyXHybrid_RHS;
  DECLARE_CCTK_PARAMETERS;
...
extern "C" void WaveToyXHybrid_Boundaries(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_WaveToyXHybrid_Boundaries;
  DECLARE_CCTK_PARAMETERS;

  // Do nothing
}

extern "C" void WaveToyXHybrid_Energy(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_WaveToyXHybrid_Energy;
  DECLARE_CCTK_PARAMETERS;
...
extern "C" void WaveToyXHybrid_Error(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTSX_WaveToyXHybrid_Error;
  DECLARE_CCTK_PARAMETERS;
